...
const Home = () => {
  const features = [
  {
    ...
    description: "Stay updated with live cryptocurrency prices and trends."
  },
  {
    title: "Advanced Trading Tools",
    description: "Utilize powerful tools for charting, analysis, and strategy building."
  },
  {
    title: "Secure Transactions",
    description: "Your trades and funds are protected with top-grade security protocols."
  },
  {
    title: "24/7 Market Updates",
    description: "Access round-the-clock updates on global crypto markets."
  }
];
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <h3 className="text-xl lg:text-2xl text-yellow-400 font-semibold mb-2 lg:mb-3">{feature.title}</h3>
                <p className="text-gray-400 lg:text-lg">{feature.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
